            ...
            <div className={classes.container}>
                <div className={classes.profile_wraper}>
                    ...
                    <form onSubmit={onSubmitHandler}>
                        <h2>Mudar a senha</h2>
                        <div className={`${classes.formControl} ${passwordHasError && classes.invalid}`}>
                            ...
                            />
                           {passwordHasError &&  <small> {passwordErrorMessage}  </small>}
                        </div>
                        <div className={classes.formControl}>
                            ...
                            <Input
                                ...
                                className={classes.input}
                            />
                           {passwordCheckHasError &&  <small> {passwordCheckErrorMessage} </small>}
                        </div>
